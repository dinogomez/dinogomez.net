  ...
  return (
    <Draggable onDrag={handleDrag} bounds="body" cancel=".btn">
      ...
      >
        ...
        <div className="lg:w-[30em] xl:w-[40em] 2xl:w-[48em] flex items-center justify-between py-4 border-2 border-dashed border-gray-300 hover:border-2 bg-white hover:border-blue-600 shadow-lg hover:cursor-move ">
          <div
            className={` ${
              hide ? "hidden" : ""
